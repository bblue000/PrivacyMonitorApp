...
public class Config {
	...
	private static final String URL_PREFIX = "http://10.101.100.70:8080/findlocation";//"http://10.101.2.60";
	...
	public static final String URL_GET_LOCATION = URL_PREFIX + "/locations/%s/%s/%s";
